...
# Demo for automated scraping books from Humor category (10 books total)
...
log_path = "./logs/automated_books.txt"
...
if __name__ == "__main__":
    ...
    with open("./data/automated_books.json", "w", encoding="utf-8") as file:
